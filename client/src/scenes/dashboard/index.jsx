...
const Dashboard = () => {
  ...
  return <Box m='1.5rem 2.5rem'>
      <FlexBetween>
        <Header title='DASHBOARD' subtitle='Overview of your Users & Sales data visualization by components!' />
        <Box>
          <Button 
            sx={{
        ...
        {/* {ROW 2} */}
          ...
          >
            ...
            <Typography p='0 0.6rem' fontSize='0.8rem' sx={{color: theme.palette.secondary[200]}}>
              Breakdown of States and Info via Category for Revenue generated for Current Year by Total Sales
            </Typography>
          </Box>
        </Box>
    </Box>
